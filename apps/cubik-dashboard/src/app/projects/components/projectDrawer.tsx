...
import {
    ...
    SheetHeader,
    SheetTrigger,
    Text, Tag, Button, AvatarLabelGroup
} from "@cubik/ui";
...
export function ProjectDrawer({ project, ...props }: DrawerProps) {
                            ...
                            <div className="flex flex-col px-3">
                                ...
                                <div className="flex flex-row flex-wrap items-start justify-start gap-3">
                                    {project?.team.map((member) => {
                                        return (
                                            <div key={member.user.id} className="box-border flex max-w-[200px] p-2">
