    ...
    <>
      <input
        ...
        className={cn(
          ...
          'block w-full flex-1 rounded-[8px] border-0 py-1.5 placeholder:px-2 placeholder:text-[var(--form-input-border-default)] outline-none focus:ring-blue-500 focus:border-blue-500',
        )}
        {...props}
      />
    </>
