...
export default function Header() {
  ...
  return (
    <>
      <header className="flex h-[70px] w-screen content-center items-center border-b border-b-[var(--color-border-primary-base)] bg-[var(--color-surface-primary-depth)] py-4 lg:static lg:overflow-y-visible">
