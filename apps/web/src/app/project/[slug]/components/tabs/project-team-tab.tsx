...
import { AvatarLabelGroup, Button, Table, TableCell, TableRow, Text } from "@cubik/ui";
                    ...
                    {team.isSuccess && team.data.length > 0 ? (
                        <div className='flex flex-col'>
                            ...
                            <Text className='max-w-md p-3' color='secondary'>
                                These are the Founders, developers, designers and product people behind {team.data[0].project?.name}
                            </Text>
